...
var Sandbox = {
	...
	Model : Backbone.Model.extend({
		...
		initialize: function() {
			...
			// Set up the iframe sandbox if neededS
		...
		addHistory: function(item) {
			...
			if (_.isUndefined(item.result)) item.result = "";
	...
	View : Backbone.View.extend({
		initialize: function(opts) {
			...
			this.placeholder = opts.placeholder || "";//"// type some command and hit enter (:help for info)"
			this.helpText = opts.helpText || "type commands into the console, hit enter to evaluate. \n[up/down] to scroll through history, ':clear' to reset it. \n[alt + return/up/down] for returns and multi-line editing.";
